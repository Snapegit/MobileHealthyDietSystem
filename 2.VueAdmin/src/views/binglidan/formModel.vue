				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="主诉" prop="zhusu">
							<el-input class="list_inp" v-model="form.zhusu" placeholder="主诉"
								 type="text" 								:readonly="!isAdd||disabledForm.zhusu?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="病史" prop="bingshi">
							<el-input class="list_inp" v-model="form.bingshi" placeholder="病史"
								 type="text" 								:readonly="!isAdd||disabledForm.bingshi?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="诊断" prop="zhenduan">
							<el-input class="list_inp" v-model="form.zhenduan" placeholder="诊断"
								 type="text" 								:readonly="!isAdd||disabledForm.zhenduan?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='zhusu'){
					form.value.zhusu = row[x];
					disabledForm.value.zhusu = true;
					continue;
				}
				if(x=='bingshi'){
					form.value.bingshi = row[x];
					disabledForm.value.bingshi = true;
					continue;
				}
				if(x=='zhenduan'){
					form.value.zhenduan = row[x];
					disabledForm.value.zhenduan = true;
					continue;
				}
				if(x=='fujian'){

		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="计划名称" prop="jihuamingcheng">
							<el-input class="list_inp" v-model="form.jihuamingcheng" placeholder="计划名称"
								 type="text" 								:readonly="!isAdd||disabledForm.jihuamingcheng?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="计划内容" prop="jihuaneirong">
							<el-input v-model="form.jihuaneirong" placeholder="计划内容" type="textarea"
							:readonly="!isAdd||disabledForm.jihuaneirong?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='jihuamingcheng'){
					form.value.jihuamingcheng = row[x];
					disabledForm.value.jihuamingcheng = true;
					continue;
				}
				if(x=='jihuaneirong'){

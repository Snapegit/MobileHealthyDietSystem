...
import com.design.appproject.logic.viewmodel.jiankangzhishi.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.JiankangzhishicommonDetailsLayoutBinding
 ...
 * 健康知识详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_JIANKANGZHISHI)
class DetailsFragment : BaseBindingFragment<JiankangzhishicommonDetailsLayoutBinding>() {
    ...
    private var mJiankangzhishiItemBean=JiankangzhishiItemBean()/*详情内容*/
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mJiankangzhishiItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("jiankangzhishi",mId.toString())
    }


    private fun JiankangzhishicommonDetailsLayoutBinding.setInfo(){
        biaotiTv.text = "${mJiankangzhishiItemBean.biaoti}"
        banner.setAdapter(DetailBannerAdapter(mJiankangzhishiItemBean.tupian.split(","))).setOnBannerListener { data, position ->
            data.toConversion<String>()?.let {
                it.showToast()
            }
        }
        jianjieTv.text = "${mJiankangzhishiItemBean.jianjie}"
        neirongCw.setHtml(mJiankangzhishiItemBean.neirong.trim())

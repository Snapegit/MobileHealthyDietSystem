...
class MainActivity : BaseBindingActivity<ActivityMainLayoutBinding>() {
    ...
    private val fragments = mutableListOf(
        ...
        ARouter.getInstance().build(CommonArouteApi.PATH_FRAGMENT_LIST_MESSAGES).withBoolean("mHasBack",false).navigation() as Fragment,
        ARouter.getInstance().build(CommonArouteApi.PATH_FRAGMENT_LIST_JIANKANGSHIPU).withBoolean("mHasBack",false).navigation() as Fragment,
        ARouter.getInstance().build(CommonArouteApi.PATH_FRAGMENT_LIST_JIANKANGZHISHI).withBoolean("mHasBack",false).navigation() as Fragment,

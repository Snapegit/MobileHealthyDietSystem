...
import com.design.appproject.logic.viewmodel.yinshijianyi.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.YinshijianyicommonDetailsLayoutBinding
 ...
 * 饮食建议详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_YINSHIJIANYI)
class DetailsFragment : BaseBindingFragment<YinshijianyicommonDetailsLayoutBinding>() {
    ...
    private var mYinshijianyiItemBean=YinshijianyiItemBean()/*详情内容*/
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mYinshijianyiItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("yinshijianyi",mId.toString())
    }


    private fun YinshijianyicommonDetailsLayoutBinding.setInfo(){
        yonghuzhanghaoTv.text = "${mYinshijianyiItemBean.yonghuzhanghao}"
        yonghuxingmingTv.text = "${mYinshijianyiItemBean.yonghuxingming}"
        riqiTv.text = "${mYinshijianyiItemBean.riqi}"
        yinshijianyiCw.setHtml(mYinshijianyiItemBean.yinshijianyi.trim())
    }

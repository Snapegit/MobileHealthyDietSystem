...
import com.design.appproject.logic.viewmodel.binglidan.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.BinglidancommonDetailsLayoutBinding
 ...
 * 病例单详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_BINGLIDAN)
class DetailsFragment : BaseBindingFragment<BinglidancommonDetailsLayoutBinding>() {
    ...
    private var mBinglidanItemBean=BinglidanItemBean()/*详情内容*/
        ...
        binding.apply{
            srv.setOnRefreshListener {
             ...
             fujianTv.setOnClickListener {/*下载*/
                DownloadUtil.download("${NetRetrofitClient.BASE_URL}file/download?fileName=${mBinglidanItemBean.fujian.replace("file/","")}","${CommonBean.DOWNLOAD_PATH}/fujian",object : DownloadListener {
    ...
    private fun loadData(){
        mDetailsViewModel.info("binglidan",mId.toString())
    }


    private fun BinglidancommonDetailsLayoutBinding.setInfo(){
        jiuzhenshijianTv.text = "${mBinglidanItemBean.jiuzhenshijian}"
        zhusuTv.text = "${mBinglidanItemBean.zhusu}"
        bingshiTv.text = "${mBinglidanItemBean.bingshi}"
        zhenduanTv.text = "${mBinglidanItemBean.zhenduan}"
        fujianTv.text = "${mBinglidanItemBean.fujian}下载文件"
        yonghuzhanghaoTv.text = "${mBinglidanItemBean.yonghuzhanghao}"
        yonghuxingmingTv.text = "${mBinglidanItemBean.yonghuxingming}"
    }

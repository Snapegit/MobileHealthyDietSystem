...
import com.design.appproject.logic.viewmodel.jiankangjihua.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.JiankangjihuacommonDetailsLayoutBinding
 ...
 * 健康计划详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_JIANKANGJIHUA)
class DetailsFragment : BaseBindingFragment<JiankangjihuacommonDetailsLayoutBinding>() {
    ...
    private var mJiankangjihuaItemBean=JiankangjihuaItemBean()/*详情内容*/
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mJiankangjihuaItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("jiankangjihua",mId.toString())
    }


    private fun JiankangjihuacommonDetailsLayoutBinding.setInfo(){
        riqiTv.text = "${mJiankangjihuaItemBean.riqi}"
        jihuamingchengTv.text = "${mJiankangjihuaItemBean.jihuamingcheng}"
        jihuaneirongTv.text = "${mJiankangjihuaItemBean.jihuaneirong}"
        yonghuzhanghaoTv.text = "${mJiankangjihuaItemBean.yonghuzhanghao}"
        yonghuxingmingTv.text = "${mJiankangjihuaItemBean.yonghuxingming}"
    }

...
public class TijianbaogaoController {
    ...
    public R page(@RequestParam Map<String, Object> params,TijianbaogaoEntity tijianbaogao,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date tijianriqistart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date tijianriqiend,
        ...
        EntityWrapper<TijianbaogaoEntity> ew = new EntityWrapper<TijianbaogaoEntity>();
                if(tijianriqistart!=null) ew.ge("tijianriqi", tijianriqistart);
                if(tijianriqiend!=null) ew.le("tijianriqi", tijianriqiend);
    ...
    public R update(@RequestBody Long[] ids, @RequestParam String sfsh, @RequestParam String shhf){
        List<TijianbaogaoEntity> list = new ArrayList<TijianbaogaoEntity>();
        for(Long id : ids) {
            TijianbaogaoEntity tijianbaogao = tijianbaogaoService.selectById(id);
            tijianbaogao.setSfsh(sfsh);
            tijianbaogao.setShhf(shhf);
            list.add(tijianbaogao);
        }
        tijianbaogaoService.updateBatchById(list);
        return R.ok();
    }

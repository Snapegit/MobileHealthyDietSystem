	...
	<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ff993310","height":"auto"}'>
		<form :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","background":"none","display":"block","height":"auto"}' class="app-update-pv">
			...
			<view :style='{"padding":"12rpx 0 12rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","borderWidth":"0 0 0px 0","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","fontWeight":"500"}' class="title">饮食建议</view>
                <xia-editor ref="editor" :style='{"minHeight":"320rpx","border":"2rpx solid #eeeeee","padding":"20rpx","color":"#666666","background":"#ffffff","width":"100%","height":"auto"}' v-model="ruleForm.yinshijianyi" placeholder="饮食建议" @editorChange="yinshijianyiChange"></xia-editor>
			</view>
...
<script>
	...
	export default {
		...
		methods: {
            yinshijianyiChange(e) {
                this.ruleForm.yinshijianyi = e
            },
			styleChange() {
				this.$nextTick(()=>{
